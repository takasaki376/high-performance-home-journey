  ...
  return (
    <div className="mx-auto max-w-3xl py-8">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-gray-900 dark:text-gray-100">広告について</h2>
          <p className="leading-relaxed text-gray-700 dark:text-gray-300">
            当ブログでは、将来的にGoogle
            AdSenseや各種アフィリエイトプログラムを利用する可能性があります。これらの広告配信業者はCookieを使用して広告を配信する場合があります。
          </p>
        </section>

        <section>
          <h2 className="mb-3 text-xl font-bold text-gray-900 dark:text-gray-100">免責事項</h2>
          <p className="leading-relaxed text-gray-700 dark:text-gray-300">
